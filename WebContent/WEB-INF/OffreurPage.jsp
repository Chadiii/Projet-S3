	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container">
			<div class="hero-warp">
				...
				<p>Notre cher propriétaire,vous pouvez estimer la valeur de votre bien avant de le déposer. </p>
						<div class="st-item">
							<a href="controleur" class="btn btn-primary btn-user btn-block">
                  Déposer votre annonce
                </a>
						</div>
						<div class="st-item">
							<a href="estimer" class="btn btn-primary btn-user btn-block">
