			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarResponsove">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="Home">admin@admin.com</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container">
			<div class="hero-warp">
				...
				<p>Cher Administrateur vous trouverez ci-dessous la liste des gestions</p>
						<div class="st-item">
							<a href="annonce" class="btn btn-primary btn-user btn-block">
                  Gérer les annonces
                </a>
						</div>
						<div class="st-item">
							<a href="reservation" class="btn btn-primary btn-user btn-block">
                 Gérer les réservations
                  ...
                  Gérer les utilisateurs
						...
						<div class="st-item">
							<a href="reservation_model" class="btn btn-primary btn-user btn-block">
                  Gérer les réservations des modèles
                </a>
						</div>
				</div>		
				...
				<div class="col-lg-6 ">
					<div class="about-text">
						...
						<h6> De méme, des petits travaux à  réaliser peuvent effrayer vos acheteurs potentiels.
						  , choisissez un accompagnement personnalisé,et profitez de conseils professionnels afin de vendre votre bien rapidement
