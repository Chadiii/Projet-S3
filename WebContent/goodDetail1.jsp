...
<div class="container">
<div class="text-left">
<a href="DemandeurHome" class="btn btn-dark">Revenir en arrière </a>
</div>
...
<br>
  ...
  <div class="jumbotron">
  	...
  	<center>
  	<img src="img_upload_model/<c:out value = "${ param.nomImage }" />" width="650" height="400" >
  	</center>
  	<h3><i class="fa fa-camera-retro"></i> Nom : <c:out value="${ param.nom }"></c:out></h3>
  	<h3> Type : <c:out value="${ param.type }"></c:out></h3>
  	...
  	<center>
  	<h4> <a href="successController1?code_model=<c:out value = "${ param.id }" />&code_user=<c:out value = "${ sessionScope.id_user }" />" class="btn btn-dark" >Reserver la construction </a> </h4>
  	</center>
  <!--  
