...
import com.JavaEE.Bean.UserImpleme;


@WebServlet("/ServletGestionDesUsers")
public class ServletGestionDesUsers extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private UserImpleme metier;
	...
	public void init() throws ServletException {
		 metier=new UserImpleme();
		
	}
    public ServletGestionDesUsers() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		if(action!=null) 
		{
			...
			if(action.equals("delete")) {
				...
				metier.deleteUser(cod);
					
				model.setUser(metier.listUser());
		...
		request.getRequestDispatcher("/GestionUser.jsp").
